/**
 * 样式数据源自 [huasheng_editor](https://github.com/alchaincyf/huasheng_editor)（MIT）。
 */
export const HUASHENG_STYLES: Record<string, { name: string; styles: Record<string, string> }> = {
  'wechat-default': {
    name: '默认公众号风格',
    styles: {
  ...
  'wechat-anthropic': {
    ...
    styles: {
      ...
      h1: 'font-size: 32px; font-weight: 600; color: #C15F3C !important; line-height: 1.2 !important; margin: 36px 0 18px; letter-spacing: -0.02em;',
      h2: 'font-size: 26px; font-weight: 600; color: #C15F3C !important; line-height: 1.25 !important; margin: 32px 0 16px; letter-spacing: -0.015em;',
...
'wechat-nyt': {
  ...
  'wechat-jonyive': {
    name: 'Jony Ive',
    styles: {
      container: 'max-width: 620px; margin: 0 auto; padding: 16px 24px 40px 24px; font-family: -apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", "Helvetica Neue", Arial, sans-serif; font-size: 17px; line-height: 1.6 !important; color: #3a3a3c !important; background-color: #fbfbfd !important; word-wrap: break-word;',
      ...
      p: 'margin: 20px 0 !important; line-height: 1.6 !important; color: #3a3a3c !important; font-weight: 400;',
      strong: 'font-weight: 500; color: #1d1d1f !important;',
      em: 'font-style: normal; color: #424245 !important; font-weight: 400;',
      a: 'color: #06c !important; text-decoration: none; font-weight: 400;',
      ul: 'margin: 20px 0; padding-left: 28px; list-style-type: disc;',
      ol: 'margin: 20px 0; padding-left: 28px; list-style-type: decimal;',
      li: 'margin: 12px 0; line-height: 1.6 !important; color: #3a3a3c !important; padding-left: 24px; position: relative; font-weight: 400;',
      ...
      code: 'font-family: "SF Mono", Monaco, Menlo, monospace; font-size: 14px; padding: 2px 6px; background-color: #f5f5f7 !important; color: #424245 !important; border-radius: 6px; font-weight: 400;',
      ...
      td: 'padding: 12px 16px; border: none; border-top: 1px solid #d2d2d7; color: #3a3a3c !important; font-weight: 400;',
      tr: 'border: none;',
    }
  },
...
'wechat-medium': {
  ...
  'wechat-apple': {
    name: 'Apple 极简',
    styles: {
      container: 'max-width: 640px; margin: 0 auto; padding: 20px 12px 40px 12px; font-family: -apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", "Helvetica Neue", Arial, sans-serif; font-size: 17px; line-height: 1.65 !important; color: #3d3d41 !important; background-color: #fbfbfd !important; word-wrap: break-word;',
      ...
      p: 'margin: 20px 0 !important; line-height: 1.7 !important; color: #3d3d41 !important; font-size: 17px;',
      strong: 'font-weight: 600; color: #1d1d1f !important;',
      em: 'font-style: normal; color: #424245 !important;',
      a: 'color: #06c !important; text-decoration: none;',
      ul: 'margin: 20px 0; padding-left: 28px; list-style-type: disc;',
      ol: 'margin: 20px 0; padding-left: 28px; list-style-type: decimal;',
      li: 'margin: 10px 0; line-height: 1.65 !important; color: #3d3d41 !important; padding-left: 24px; position: relative;',
      ...
      code: 'font-family: "SF Mono", Monaco, Menlo, monospace; font-size: 15px; padding: 2px 6px; background-color: #f5f5f7 !important; color: #424245 !important; border-radius: 8px;',
      ...
      td: 'padding: 10px 16px; border: none; border-top: 1px solid #d2d2d7; color: #3d3d41 !important;',
      tr: 'border: none;',
    }
  },
  ...
  'kenya-emptiness': {
    ...
    styles: {
      ...
      p: 'margin: 40px 0 !important; line-height: 2.5 !important; color: #2c2c2c !important; letter-spacing: 0.05em;',
      ...
      li: 'margin: 30px 0; line-height: 2.5 !important; color: #2c2c2c !important; padding-left: 40px; position: relative;',
  ...
  'gaudi-organic': {
    ...
    styles: {
      ...
      h1: 'font-size: 32px; font-weight: 700; color: #c0392b !important; line-height: 1.25 !important; margin: 36px 0 18px; text-align: center; letter-spacing: -0.02em; position: relative; padding: 12px;',
